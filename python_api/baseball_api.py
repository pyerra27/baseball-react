...
def team_batting(team_id: str = Path(None, description = "team ids can be found using /franchises endpoint"), 
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="No data for given year")
    ...
    ### give columns the correct type compared to the the statistic
